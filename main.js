...
await axios.post(`https://crudcrud.com/api/2152ae0467c847a4a111caa8c6bd2f69/dishdata`, { dishdata })
  .then((res) => {
  ...
  axios.get(`https://crudcrud.com/api/2152ae0467c847a4a111caa8c6bd2f69/dishdata`)
  .then((res) => { 
...
//remove from server 
axios
.delete(`https://crudcrud.com/api/2152ae0467c847a4a111caa8c6bd2f69/dishdata/${btnId}`)
...
.get(`https://crudcrud.com/api/2152ae0467c847a4a111caa8c6bd2f69/dishdata`)
.then((res) => { 
